...
require([
    "dojo/_base/declare", "GroupBoxPlus/widget/GroupBoxPlus"
], function(declare, _groupBoxPlusWidget) {
    return declare("GroupBoxPlus.widget.GroupBoxPlusNoContext", [_groupBoxPlusWidget], {
...
require(["GroupBoxPlus/widget/GroupBoxPlusNoContext"], function() {
    "use strict";
});
//
// define([
